...
public class KmpMatcher
{
   ...
   */
  public KmpMatcher(byte[] toMatch)
  { 
    _match=toMatch;
  ...
  /**
   * Match the match sequence with the bytes seen so far.
   *
   *@return Whether the supplied byte completes
   *  a match.
   */
  public final boolean match(final byte c)
  {
