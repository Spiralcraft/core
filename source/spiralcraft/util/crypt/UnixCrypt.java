...
/**
 * Utility class to provide legacy Unix style password encryption, primarily
 *   for backwards compatibility.
 * 
 * Java-based implementation of the unix crypt command
 *
 * Based upon C source code written by Eric Young, eay@psych.uq.oz.au,
 *   originally licensed under the BSD license, as this is derivative,
 *   the same license applies.
 *   
 * Based on Java conversion by John F. Dumas
 * 
 * @author mike
 */
public class UnixCrypt
{
  ...
  public static final String cryptNoSalt(String original)
  {
     ...
     int Eswap0 = 0; // con_salt[(int)charZero];
     int Eswap1 = 0; // con_salt[(int)charOne] << 4;
 ...
 /**
  * Unix password style encryption
  *
  * Generate a random salt.
  */
 public static final String encryptPassword(String clearPass)
 { return crypt(RandomUtil.generateString(2),clearPass);
 }
 ...
 { 
   ...
   for (int p0=32;p0<128;p0++)
   {
     ...
     for (int p1=32;p1<128;p1++)
     {
       pass[1]=(char) p1;
       System.out.println("p1:"+p1);
       for (int p2=32;p2<128;p2++)
       {
         pass[2]=(char) p2;
         System.out.println("p2:"+p2);
         for (int p3=32;p3<128;p3++)
         {
           pass[3]=(char) p3;
           System.out.println("p3:"+p3);
           for (int p4=32;p4<128;p4++)
           {
             pass[4]=(char) p4;
             System.out.println("p4:"+p4);
             for (int p5=32;p5<128;p5++)
             {
               pass[5]=(char) p5;
               System.out.println("p5:"+p5);
               for (int p6=32;p6<128;p6++)
               {
                 pass[6]=(char) p6;
                 for (int p7=32;p7<128;p7++)
                 {
                   pass[7]=(char) p7;
